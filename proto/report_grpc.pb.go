...
const (
	ReportService_GenerateReport_FullMethodName = "/reportservice.ReportService/GenerateReport"
	ReportService_HealthCheck_FullMethodName    = "/reportservice.ReportService/HealthCheck"
)
...
type ReportServiceClient interface {
	GenerateReport(ctx context.Context, in *SendReportRequest, opts ...grpc.CallOption) (*SendReportResponse, error)
...
func (c *reportServiceClient) GenerateReport(ctx context.Context, in *SendReportRequest, opts ...grpc.CallOption) (*SendReportResponse, error) {
...
type ReportServiceServer interface {
	GenerateReport(context.Context, *SendReportRequest) (*SendReportResponse, error)
...
func (UnimplementedReportServiceServer) GenerateReport(context.Context, *SendReportRequest) (*SendReportResponse, error) {
...
func _ReportService_GenerateReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GenerateReport(ctx, req.(*SendReportRequest))
	}
